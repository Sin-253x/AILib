 ...
 * ======================== 代码解释 ========================
 * 1. 整体功能：
 *    提供认证后的文件上传表单，把 TXT / Markdown 文件提交给后端解析。
 *
 * 2. 关键部分拆解：
 *    - file：保存用户选择的文件。
 ...
 *
 * 4. 潜在问题与改进建议：
 *    - 当前只支持 TXT / Markdown；PDF 后续需要后端解析库支持。
 ...
 * ========================================================
 */
export function DocumentUploadForm({ token, onUploaded }: { token: string; onUploaded: () => void }) {
